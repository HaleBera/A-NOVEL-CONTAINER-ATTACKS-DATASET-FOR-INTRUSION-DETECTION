...
class XSS_CVE_2019_7543_Attacker1(AttackerBase):
    ...
    def main(self):
        ...
        self.commandRunner.runCommand('nuclei -u http://localhost:30002 -t ~/Desktop/TESTING_PHASE/Z/A-NOVEL-CONTAINER-ATTACKS-DATASET-FOR-INTRUSION-DETECTION/Scripts/YAMLs/CVE-2019-7543.yaml -debug')
