...
class XSS_CVE_2019_7543_Attacker6(AttackerBase):
    ...
    def main(self):
        ...
        self.commandRunner.runCommand('nuclei -u http://144.122.71.18:30002 -t ~/A-NOVEL-CONTAINER-ATTACKS-DATASET-FOR-INTRUSION-DETECTION/Scripts/YAMLs/CVE-2019-7543_payload5.yaml -debug')
