...
from SQLI_CVE_2020_9483_Attacker4 import SQLI_CVE_2020_9483_Attacker4
from SQLI_CVE_2020_9483_Attacker5 import SQLI_CVE_2020_9483_Attacker5
from SQLI_CVE_2020_9483_Attacker6 import SQLI_CVE_2020_9483_Attacker6
...
if __name__ == '__main__':
    ...
    for r in range(Round_Number):
	    attacks =  [SQLI_CVE_2020_9483_Attacker1(ip_addr, yaml_path),\
		       SQLI_CVE_2020_9483_Attacker2(ip_addr, yaml_path),\
		       SQLI_CVE_2020_9483_Attacker3(ip_addr, yaml_path),\
		       SQLI_CVE_2020_9483_Attacker4(ip_addr, yaml_path),\
		       SQLI_CVE_2020_9483_Attacker5(ip_addr, yaml_path),\
		       SQLI_CVE_2020_9483_Attacker6(ip_addr, yaml_path)]
